...
<table style="width:100%">
  ...
  <tr>
    <td>Interacciones elementales entre la teoría de modelos, el álgebra y la geometría algebraica ```pdf```</td>
    <td>Joel Torres del Valle</td>
    <td>Angie Paola Isaza Jaramillo </td>
  </tr>
  <tr>
    <td>Grupo de Grothendieck de un anillo ```pdf```</td>
    <td>Juan Omar Gómez</td>
    <td>Julián Andrés Montenegro Parra</td>
  </tr>
  <tr>
    <td>Una vista a través de homologías ```pdf```</td>
    <td>Juan Sebastián Gaitán</td>
    <td>José Esteban Bastidas Zapata</td>
  </tr>
  <tr>
    <td>Dualidad de Poincaré ```pdf```</td>
    <td>Juan Sebastián Jaramillo Díaz</td>
    <td>Jhon Alexander Yam Borges</td>
  </tr>
  <tr>
    <td>Introducción a la criptografía de clave pública ```pdf```</td>
  ...
  <tr>
    <td>Ideales de Stanley-Reisner: una relación entre el álgebra y la combinatoria ```pdf```</td>
  ...
  <tr>
    <td>Convergencia de las series de Fourier ```pdf```</td>
  ...
  <tr>
    <td>Grupo fundamental, aplicaciones y CW complejos ```pdf```/td>
    <td><a href="https://schavesr.com/">Sergio Chaves</a></td>
    <td>Yuhad Olarte Ibrahim</td>
  </tr>
  <tr>
    <td>Primos de la forma \(x^{2} + ny^{2}\) ```pdf```</td>
